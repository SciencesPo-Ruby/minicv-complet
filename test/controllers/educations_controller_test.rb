...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { date_debut: @education.date_debut, date_fin: @education.date_fin, ecole: @education.ecole, nom: @education.nom } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { date_debut: @education.date_debut, date_fin: @education.date_fin, ecole: @education.ecole, nom: @education.nom } }
